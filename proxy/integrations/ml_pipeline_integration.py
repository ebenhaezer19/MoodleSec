...
def generate_manual_test_requests() -> list[Dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "uri": "http://localhost/mod/url/view.php?redirect=http://127.0.0.1:8080/admin",
            "method": "GET",
            "headers": {"User-Agent": "Mozilla/5.0"},
            "body": "",
        },
        {
            ...
            "uri": "http://localhost/lib/ajax/service.php?url=http://169.254.169.254/latest/meta-data/",
            "method": "GET",
            "headers": {"User-Agent": "Mozilla/5.0"},
            "body": "",
        },
        {
            "name": "lfi_encoded_traversal",
            "uri": "http://localhost/pluginfile.php?file=..%2F..%2F..%2Fetc%2Fpasswd",
            "method": "GET",
            "headers": {"User-Agent": "Mozilla/5.0"},
            "body": "",
        },
        {
            ...
            "uri": "http://localhost/admin/tool/task/schedule_task.php",
            "method": "POST",
            "headers": {"User-Agent": "Mozilla/5.0", "Content-Type": "application/x-www-form-urlencoded"},
            "body": "file=php://filter/convert.base64-encode/resource=config.php",
        },
        {
            "name": "lfi_null_byte",
            "uri": "http://localhost/mod/resource/view.php?file=../../config.php%00.jpg",
            "method": "GET",
            "headers": {"User-Agent": "Mozilla/5.0"},
            "body": "",
        },
